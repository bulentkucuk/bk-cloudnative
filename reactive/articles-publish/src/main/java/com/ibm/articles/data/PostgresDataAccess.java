...
public class PostgresDataAccess implements DataAccess {
    ...
    public PostgresDataAccess() {
        System.out.println("com.ibm.articles.data.PostgresDataAccess.PostgresDataAccess");
    }

    @PostConstruct
    void config() {
        System.out.println("com.ibm.articles.data.PostgresDataAccess.config");
        //initDb(); -- database is initialised by the Articles microservice.
    }

    private void initDb() {
        System.out.println("com.ibm.articles.data.PostgresDataAccess.initDb");
    ...
    public CompletionStage<Article> addArticleReactive(Article article) {
        System.out.println("com.ibm.articles.data.PostgresDataAccess.addArticleReactive");
    ...
    public CompletionStage<Article> getArticleReactive(String id) {
        System.out.println("com.ibm.articles.data.PostgresDataAccess.getArticleReactive");
    ...
    private static Article fromRow(Row row) {
        System.out.println("com.ibm.articles.data.PostgresDataAccess.fromRow");
